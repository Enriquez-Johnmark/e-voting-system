			...
			<div class="kt-login__container">
				<div class="kt-login__signin">
					<div class="kt-login__head">
						<h3 class="kt-login__title" style="color:white;">Register In To Admin</h3>
					</div>
                    ...
                    @endif
					<form class="kt-form" method="post" action="{{route('admin.register')}}">
						...
						<div class="input-group">
							<input class="form-control" style="color:white;" type="password" placeholder="Confirm Password" name="rpassword">
						</div>
