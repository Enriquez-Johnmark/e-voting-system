...
<body>
	...
	<div class="col-md-6">
		...
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<form class="kt-form" method="post" action="{{ route('title.store')}}" enctype="multipart/form-data">
				<div class="kt-portlet__body">
                  <br>
                  <div class="form-group row" style="margin-bottom: 20px;">
                      @csrf
                      <label for="example-text-input" class="col-3 col-form-label">Election Title:*</label>
                      <div class="col-8">
                          <input class="form-control" name="name" type="text" placeholder="Election Title" required="">
                      </div>
                  </div>
                </div>
                <br>
