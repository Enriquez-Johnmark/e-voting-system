...
<div class="kt-container  kt-container--fluid ">
        ...
        @if(Session::has('success'))
            <div class="alert alert-success" role="alert">
                        ...
                        <div class="alert-text" style="font-size:15px;">{{Session::get('success')}}
...
<!--  <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#addProduct">Add Products</button> -->
    <button type="button" class="btn btn-primary waves-effect waves-light" id="add_product">Add New Candidate</button>
...
$('#add_product').click(function () {
    $('#product_content').load("{{ route('candidate.create')}}");
});
</script>
